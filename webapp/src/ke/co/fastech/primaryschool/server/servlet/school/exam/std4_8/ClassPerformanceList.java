 ...
 *
 */
public class ClassPerformanceList  extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(StringUtils.equals(examType, "OPENER")){
			title = "_____________________________________ \n"
					+ " Opener Exam Result for : " + classroom.getClassName() + " \nTERM : " + systemConfig.getTerm() + " YEAR : " + systemConfig.getYear() + "  "+"\n"; 

		}if(StringUtils.equals(examType, "MIDTERM")){
			title = "_____________________________________ \n"
					+ " Mid-Term Exam Result for : " + classroom.getClassName() + " \nTERM : " + systemConfig.getTerm() + " YEAR : " + systemConfig.getYear() + " "+"\n";

		}if(StringUtils.equals(examType, "ENDTERM")){
			title = "_____________________________________ \n"
					+ " End of Term Exam Result for : " + classroom.getClassName() + " \nTERM : " + systemConfig.getTerm() + " YEAR : " + systemConfig.getYear() + " "+"\n";
	...
	private void populatePDFDocument(Account school, String classuuid,List<ExamResult> classdistinctlist,
		...
		try {
			...
			subjectScoreTable.setWidths(new int[]{10,15,20,33,12,12,13,12,12,12,18,20,15,15,15,15});   
			...
			subAnalysisTable.addCell(new Paragraph("ENG :\nEntry " + performanceDAO.getSubjectCountPerClass(school.getUuid(),ExamConstants.SUB_ENG,classuuid,systemConfig.getTerm(),systemConfig.getYear()),boldNewRoman7));
			subAnalysisTable.addCell(new Paragraph("KISW :\nEntry " + performanceDAO.getSubjectCountPerClass(school.getUuid(),ExamConstants.SUB_KIS,classuuid,systemConfig.getTerm(),systemConfig.getYear()),boldNewRoman7));

			subAnalysisTable.addCell(new Paragraph("MATH : Entry " + performanceDAO.getSubjectCountPerClass(school.getUuid(),ExamConstants.SUB_MATH,classuuid,systemConfig.getTerm(),systemConfig.getYear()),boldNewRoman7));
			subAnalysisTable.addCell(new Paragraph("SCI :\nEntry " + performanceDAO.getSubjectCountPerClass(school.getUuid(),ExamConstants.SUB_SCI,classuuid,systemConfig.getTerm(),systemConfig.getYear()),boldNewRoman7));
			subAnalysisTable.addCell(new Paragraph("SS :\nEntry " + performanceDAO.getSubjectCountPerClass(school.getUuid(),ExamConstants.SUB_SST,classuuid,systemConfig.getTerm(),systemConfig.getYear()),boldNewRoman7));

			subAnalysisTable.addCell(new Paragraph("CRE :\nEntry " + performanceDAO.getSubjectCountPerClass(school.getUuid(),ExamConstants.SUB_CRE,classuuid,systemConfig.getTerm(),systemConfig.getYear()),boldNewRoman7));
			subAnalysisTable.addCell(new Paragraph("SS-CRE : Entry " + performanceDAO.getSubjectCountPerClass(school.getUuid(),ExamConstants.SUB_SST,classuuid,systemConfig.getTerm(),systemConfig.getYear()),boldNewRoman7));
			...
			for(Object o : examList){
				...
				List<ExamResult> streamperformancelist = performanceDAO.getStudentPerformanceByClassId(finalstudentuuid,
						classuuid, systemConfig.getTerm(), systemConfig.getYear());
			...
			engmean = engtotal/performanceDAO.getSubjectCountPerClass(school.getUuid(),ExamConstants.SUB_ENG,classuuid,systemConfig.getTerm(),systemConfig.getYear());
			kismean =  kistotal/performanceDAO.getSubjectCountPerClass(school.getUuid(),ExamConstants.SUB_KIS,classuuid,systemConfig.getTerm(),systemConfig.getYear());
			mathmean  =  mathtotal/performanceDAO.getSubjectCountPerClass(school.getUuid(),ExamConstants.SUB_MATH,classuuid,systemConfig.getTerm(),systemConfig.getYear());
			scimean  =  scitotal/performanceDAO.getSubjectCountPerClass(school.getUuid(),ExamConstants.SUB_SCI,classuuid,systemConfig.getTerm(),systemConfig.getYear());
			ssmean  =  sstotal/performanceDAO.getSubjectCountPerClass(school.getUuid(),ExamConstants.SUB_SST,classuuid,systemConfig.getTerm(),systemConfig.getYear());
			cremean  =  cretotal/performanceDAO.getSubjectCountPerClass(school.getUuid(),ExamConstants.SUB_CRE,classuuid,systemConfig.getTerm(),systemConfig.getYear());
			sscremean  =  sscretotal/performanceDAO.getSubjectCountPerClass(school.getUuid(),ExamConstants.SUB_SST,classuuid,systemConfig.getTerm(),systemConfig.getYear());
