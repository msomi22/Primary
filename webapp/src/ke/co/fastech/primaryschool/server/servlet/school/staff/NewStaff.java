...
public class NewStaff extends HttpServlet{
	...
	final String ERROR_STAFF_NOT_ADDED = "Something went wrong while adding the new staff.";
	final String SUCCESS_STAFF_ADDED = "Staff added successfully.";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(StringUtils.isBlank(categoryuuid)){
			...
			session.setAttribute(SessionConstants.STAFF_ERROR, ERROR_PROVIDE_USERNAME); 
			...
			session.setAttribute(SessionConstants.STAFF_ERROR, ERROR_STAFF_NOT_ADDED);  
			...
			users.setPassword(StringUtils.reverse(username));  
			...
			if(staffDAO.putStaff(staff)){ 
				...
				session.setAttribute(SessionConstants.STAFF_SUCCESS, SUCCESS_STAFF_ADDED);  
			}else{
				session.setAttribute(SessionConstants.STAFF_ERROR, ERROR_STAFF_NOT_ADDED);  
			}
