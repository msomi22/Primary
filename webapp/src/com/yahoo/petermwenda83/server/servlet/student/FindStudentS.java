...
public class FindStudentS extends HttpServlet{
   ...
   protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       if(StringUtils.isBlank(admissionNumber)){
		   ...
		   paramHash.put("firstname", StringUtils.capitalize(student.getFirstname().toLowerCase())); 
		   paramHash.put("lastname", StringUtils.capitalize(student.getLastname().toLowerCase())); 
		   paramHash.put("surname", StringUtils.capitalize(student.getSurname().toLowerCase())); 
