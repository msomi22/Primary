...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-content">
                  ...
                  <form  class="form-horizontal" action="newTeacherSubject" method="POST" >
                    <fieldset>
                   ...
                   <div class="control-group" id="divid">
                        <label class="control-label" for="subjectuuid">Subjects*</label>
                        <div class="controls">
                            <select name="subjectuuid" >
                                <option value="">Please select one</option> 
                                 <%
                                    int count = 1;
                                     for(Subject sub : subjectList) {
                                %>
                                <option value="<%=sub.getUuid()%>"><%=sub.getSubjectName()%></option> 
                                <%
                                            count++;
                                        }
                                %>
