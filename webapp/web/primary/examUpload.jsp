...
<%@page import="ke.co.fastech.primaryschool.server.servlet.school.upload.ScorePerClass"%>
...
<div class="row-fluid sortable">
        ...
        <div class="box-content">
            <div>
                ...
                <p>The results file <code>eng score,Kisw score,math score, sci score, ss score, cre score</code><p> 
                <p>The file must be saved as <code> classname.examcode</code><p> 
                 <p>Download this sample excel file  <a href="../resources/STD_4_T.OPENER.xlsx">Download</a>    </p>
                <form method="POST" action="scorePerClass" enctype="multipart/form-data">
                <fieldset>
                 ...
                 <h3>
                <%
                    if(StringUtils.isNotBlank((String)session.getAttribute(ScorePerClass.UPLOAD_FEEDBACK ))) {
                    String servletResponse =(String)session.getAttribute(ScorePerClass.UPLOAD_FEEDBACK );
                        out.println(servletResponse);
                        //used by javascript 
                        if(servletResponse!=null){notNull=servletResponse.substring(0,10);
                        }                    
                        session.setAttribute(ScorePerClass.UPLOAD_FEEDBACK, null);
                    }
                %>  
                </h3>
