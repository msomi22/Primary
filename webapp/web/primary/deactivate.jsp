...
<div class="row-fluid sortable">
    ...
    <div class="box span12">
        ...
        <h3>Deactivate per class</h3>

        <form  class="form-horizontal" action="deactivatePerStream" method="POST" >
                    <fieldset>


                     <div class="control-group" id="divid">
                        <label class="control-label" for="streamuuid">Class to Deactivate*</label>
                        <div class="controls">
              ...
              <h3>Deactivate per student</h3>

              <form  class="form-horizontal" action="deactivatePerStudent" method="POST" >
                    <fieldset>
               ...
               <h3>Activate per class</h3>

        <form  class="form-horizontal" action="activatePerStream" method="POST" >
                    <fieldset>


                     <div class="control-group" id="divid">
                        <label class="control-label" for="streamuuid">Class to Activate*</label>
                        <div class="controls">
                            <select name="streamuuid" >
                                <option value="">Please select one</option> 
                                 <%
