...
<footer>
    <p class="pull-left">&copy; <a href="" target="_blank">Fastech Solutions Ltd</a> <%= Calendar.getInstance().get(Calendar.YEAR)%>. All Rights Reserved .
    </p>
    <p class="pull-right">Contact Developer:- Peter Mwenda <a href="#"> +254789495443 </a></p>
</footer>
...
<!-- Ajax 2.5 -->
<script src="../js/ajax/glm-ajax.js"></script>
